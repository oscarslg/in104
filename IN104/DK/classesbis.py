...
class Perso:
	...
	def deplacer(self, direction):
		"""Methode permettant de déplacer le personnage de manière continue jusqu'a ce que ce dernier rencontre un mur """

		#Déplacement vers la droite
		if direction == 'droite':
			#Pour ne pas dépasser l'écran
			while self.case_x < (nombre_sprite_cote - 1) and self.niveau.structure[self.case_y][self.case_x+1] != 'm': # double vérification frontière plus mur 
